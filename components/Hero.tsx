...
export default function Hero() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-10 md:pt-14">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-start">
            ...
            <div className="lg:col-span-5">
              {/* start na wysokości nagłówka */}
              <div className="lg:pt-[64px]">
                <div className="relative">
                  {/* ✅ Ilustracja (2 osoby) jako tło, żeby nie robić bałaganu */}
                  <div className="pointer-events-none absolute -top-10 -right-6 h-[260px] w-[360px] opacity-[0.28] md:opacity-[0.32]">
                    <Image
      ...
      {/* Sekcja poniżej – jasnoszare tło + 3 kafle */}
