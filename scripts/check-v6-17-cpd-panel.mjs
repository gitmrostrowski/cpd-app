...
assert.match(panel, />Reguły CRPE:<\//, "Panel musi odróżniać obliczenia według reguł CRPE");
assert.match(panel, />Status formalny:<\//, "Panel musi pokazywać odrębny status formalny");
