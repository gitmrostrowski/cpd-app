...
const checks = [
  ...
  ["role labels stay neutral while role identity lives in icons", page.includes("font-extrabold leading-4 text-crpe-ink sm:text-[13px]") && page.includes("theme.accentStrong") && page.includes("theme.accentSoft")],
