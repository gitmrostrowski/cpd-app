...
const checks = [
  ...
  ["display typeface is loaded and wired to headings", layout.includes("Bricolage_Grotesque") && css.includes("--font-display:") && css.includes("h1, h2, h3, .font-display")],
  ...
  ["role photos are in place", ["medyk", "placowka", "organizator", "dokument"].every((k) => exists(`public/home/photo-${k}.webp`))],
