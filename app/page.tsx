          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white px-3 py-1.5 text-xs font-medium text-blue-800 shadow-sm">
                ...
                Platforma umożliwia monitorowanie aktywności edukacyjnej i postępów uczestników, wspiera organizacje w zarządzaniu procesem edukacyjnym i obowiązkami regulacyjnymi
              </div>
