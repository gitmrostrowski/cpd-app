...
/* ─── Design tokens — identyczne z Panel CPD ────────────────────────────── */
  ...
  const steps = [
    {
      ...
      title: "Wybierz zawód", subtitle: "System sam ustawi wymagania",
    ...
    },
    {
      ...
      title: "Dodaj aktywność", subtitle: "Zdjęcie z telefonu wystarczy",
    ...
    },
    {
      ...
      title: "Masz pełny obraz", subtitle: "Zawsze wiesz co robić dalej",
  ...
  return (
    <div className="bg-slate-100 pb-4">
      <div className="mx-auto max-w-6xl space-y-4 px-4 pt-2">
        ...
        {/* ── PODMENU — identyczne z Panel CPD ──────────────────────── */}
        ...
        <div id="hero" className={`${cardCls} scroll-mt-32`}>
          <div className="relative grid grid-cols-1 gap-8 p-6 lg:grid-cols-2 lg:items-start lg:p-8">
            ...
            <div>
              ...
              <h1 className="text-[36px] font-bold leading-[1.1] tracking-tight text-slate-900 md:text-[44px]">
              ...
              {/* Feature grid z ikonkami — jak Panel CPD stat cards */}
            ...
            <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                ...
                <div className="mt-3 grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div key={s.label} className="rounded-lg border border-slate-100 bg-slate-50">
                      <StatCard target={s.target} label={s.label} color={s.accent ? "text-red-500" : "text-slate-900"} />
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="border-t border-slate-100 px-5 pb-4">
                ...
                <div className="overflow-hidden rounded-lg border border-blue-200 bg-blue-600 px-4 py-3">
