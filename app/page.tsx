...
export default function Page() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      // niezalogowany → landing (Hero sam robi swoją “wizualkę” i skrót punktów)
      if (!user) {
        setChecking(false);
        return;
      }

      // profil (bramka do onboardingu)
      ...
      <section className="relative">
        ...
        <div className="mx-auto max-w-6xl px-4 pt-10 pb-12">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <Link
              href="/activities"
              className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm hover:bg-slate-50 transition"
            >
              <div className="text-sm text-slate-500">Dziennik</div>
              <div className="mt-1 text-lg font-semibold text-slate-900">
                Aktywności + certyfikaty
              </div>
              <div className="mt-2 text-sm text-slate-600">
                Dodawaj wpisy i porządkuj dokumenty.
              </div>
            </Link>
            ...
            >
              ...
              <div className="mt-2 text-sm text-slate-600">
                Punkty w okresie + ostatnie wpisy.
              </div>
            </Link>
            ...
            >
              ...
              <div className="mt-2 text-sm text-slate-600">
                Symulacje i szybkie “ile brakuje”.
              </div>
            </Link>
          </div>
        </div>
