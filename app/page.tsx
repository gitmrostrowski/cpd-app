...
export default function Page() {
  ...
  // =========================
  if (!userEmail) {
    // demo/fallback dla niezalogowanych (żeby widget nie był “martwy”)
    ...
    return (
      <>
        ...
        {/* „Jak to działa” — sekcja z instrukcją + podglądem */}
